...
package fr.ensimag.deca.syntax;
    ...
    import fr.ensimag.deca.tree.trigo.*;
...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		ESPACE=1, EOL=2, COMMENT=3, INSTANCEOF=4, EQEQ=5, ASIN=6, ACOS=7, ATAN=8, 
		TAN=9, SIN=10, COS=11, NEQ=12, LEQ=13, GEQ=14, GT=15, LT=16, THIS=17, 
		NULL=18, NEW=19, PLUS=20, EXCLAM=21, DOT=22, MINUS=23, TIMES=24, PERCENT=25, 
		SLASH=26, ELSE=27, OR=28, OBRACE=29, CBRACE=30, OPARENT=31, CPARENT=32, 
		COMMA=33, EQUALS=34, SEMI=35, PRINT=36, PRINTLN=37, PRINTX=38, PRINTLNX=39, 
		RETURN=40, WHILE=41, IF=42, ASM=43, TRUE=44, FALSE=45, READINT=46, READFLOAT=47, 
		AND=48, CLASS=49, EXTENDS=50, PROTECTED=51, IDENT=52, INT=53, EXP=54, 
		FLOAT=55, STRING=56, MULTI_LINE_STRING=57, INCLUDE=58;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			null, "' '", null, null, "'instanceof'", "'=='", "'asin'", "'acos'", 
			"'atan'", "'tan'", "'sin'", "'cos'", "'!='", "'<='", "'>='", "'>'", "'<'", 
			"'this'", "'null'", "'new'", "'+'", "'!'", "'.'", "'-'", "'*'", "'%'", 
			"'/'", "'else'", "'||'", "'{'", "'}'", "'('", "')'", "','", "'='", "';'", 
			"'print'", "'println'", "'printx'", "'printlnx'", "'return'", "'while'", 
			"'if'", "'asm'", "'true'", "'false'", "'readInt'", "'readFloat'", "'&&'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "ESPACE", "EOL", "COMMENT", "INSTANCEOF", "EQEQ", "ASIN", "ACOS", 
			"ATAN", "TAN", "SIN", "COS", "NEQ", "LEQ", "GEQ", "GT", "LT", "THIS", 
			"NULL", "NEW", "PLUS", "EXCLAM", "DOT", "MINUS", "TIMES", "PERCENT", 
			"SLASH", "ELSE", "OR", "OBRACE", "CBRACE", "OPARENT", "CPARENT", "COMMA", 
			"EQUALS", "SEMI", "PRINT", "PRINTLN", "PRINTX", "PRINTLNX", "RETURN", 
			"WHILE", "IF", "ASM", "TRUE", "FALSE", "READINT", "READFLOAT", "AND", 
			"CLASS", "EXTENDS", "PROTECTED", "IDENT", "INT", "EXP", "FLOAT", "STRING", 
			"MULTI_LINE_STRING", "INCLUDE"
		};
	}
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 121869836621844416L) != 0)) {
				{
				{
				setState(122);
	...
	public final If_then_elseContext if_then_else() throws RecognitionException {
		...
		enterRule(_localctx, 18, RULE_if_then_else);
		    ...
		    ListInst treeElse = new ListInst();
		...
		try {
			...
			match(CBRACE);
			        ...
			        currentTree = new IfThenElse(((If_then_elseContext)_localctx).condition.tree, ((If_then_elseContext)_localctx).li_if.tree, treeElse);
			        setLocation(currentTree, ((If_then_elseContext)_localctx).if1);
			        ((If_then_elseContext)_localctx).tree =  currentTree;
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					match(CBRACE);
					        ...
					        IfThenElse newIfThenElse = new IfThenElse(((If_then_elseContext)_localctx).elsif_cond.tree, ((If_then_elseContext)_localctx).elsif_li.tree, tempElseBranch);
					        setLocation(newIfThenElse, ((If_then_elseContext)_localctx).elsif);
					        currentTree.setElseBranch(new ListInst());
					        currentTree.add(newIfThenElse);
					        currentTree = newIfThenElse;
			...
			if (_la==ELSE) {
				...
				match(CBRACE);
				        ...
				        currentTree.setElseBranch(((If_then_elseContext)_localctx).li_else.tree);
	...
	public final List_exprContext list_expr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 121861074888560576L) != 0)) {
				{
				setState(214);
		...
		try {
			...
			case EQUALS:
				...
				((Assign_exprContext)_localctx).e2 = assign_expr();
				            ...
				            AbstractLValue lvalue = (AbstractLValue) ((Assign_exprContext)_localctx).e.tree;
				            ((Assign_exprContext)_localctx).tree =  new Assign(lvalue,((Assign_exprContext)_localctx).e2.tree);
	...
	public static class Primary_exprContext extends ParserRuleContext {
		...
		public TerminalNode SIN() { return getToken(DecaParser.SIN, 0); }
		public TerminalNode COS() { return getToken(DecaParser.COS, 0); }
		public TerminalNode TAN() { return getToken(DecaParser.TAN, 0); }
		public TerminalNode ASIN() { return getToken(DecaParser.ASIN, 0); }
		public TerminalNode ACOS() { return getToken(DecaParser.ACOS, 0); }
		public TerminalNode ATAN() { return getToken(DecaParser.ATAN, 0); }
		...
		try {
			...
			case 2:
				...
				match(CPARENT);
				            ...
				            ((Primary_exprContext)_localctx).tree =  ((Primary_exprContext)_localctx).m.tree;
			...
			case 9:
				...
				{
				setState(436);
				((Primary_exprContext)_localctx).SIN = match(SIN);
				setState(437);
				match(OPARENT);
				setState(438);
				((Primary_exprContext)_localctx).e = expr();
				setState(439);
				match(CPARENT);

				            assert(((Primary_exprContext)_localctx).e.tree != null);
				            ((Primary_exprContext)_localctx).tree =  new Sin(((Primary_exprContext)_localctx).e.tree);
				            setLocation(_localctx.tree, ((Primary_exprContext)_localctx).SIN);
			...
			case 10:
				...
				{
				setState(442);
				((Primary_exprContext)_localctx).COS = match(COS);
				setState(443);
				match(OPARENT);
				setState(444);
				((Primary_exprContext)_localctx).e = expr();
				...
				match(CPARENT);
				            ...
				            assert(((Primary_exprContext)_localctx).e.tree != null);
				            ((Primary_exprContext)_localctx).tree =  new Cos(((Primary_exprContext)_localctx).e.tree);
				            setLocation(_localctx.tree, ((Primary_exprContext)_localctx).COS);
			...
			case 11:
				...
				{
				setState(448);
				((Primary_exprContext)_localctx).TAN = match(TAN);
				setState(449);
				match(OPARENT);
				setState(450);
				((Primary_exprContext)_localctx).e = expr();
				...
				match(CPARENT);
				            ...
				            assert(((Primary_exprContext)_localctx).e.tree != null);
				            ((Primary_exprContext)_localctx).tree =  new Tan(((Primary_exprContext)_localctx).e.tree);
				            setLocation(_localctx.tree, ((Primary_exprContext)_localctx).TAN);
			...
			case 12:
				...
				{
				setState(454);
				((Primary_exprContext)_localctx).ASIN = match(ASIN);
				setState(455);
				match(OPARENT);
				setState(456);
				((Primary_exprContext)_localctx).e = expr();
				...
				match(CPARENT);
				            ...
				            assert(((Primary_exprContext)_localctx).e.tree != null);
				            ((Primary_exprContext)_localctx).tree =  new Asin(((Primary_exprContext)_localctx).e.tree);
				            setLocation(_localctx.tree, ((Primary_exprContext)_localctx).ASIN);
			...
			case 13:
				...
				{
				setState(460);
				((Primary_exprContext)_localctx).ACOS = match(ACOS);
				setState(461);
				match(OPARENT);
				setState(462);
				((Primary_exprContext)_localctx).e = expr();
				...
				match(CPARENT);
				            ...
				            assert(((Primary_exprContext)_localctx).e.tree != null);
				            ((Primary_exprContext)_localctx).tree =  new Acos(((Primary_exprContext)_localctx).e.tree);
				            setLocation(_localctx.tree, ((Primary_exprContext)_localctx).ACOS);
			...
			case 14:
				...
				{
				setState(466);
				((Primary_exprContext)_localctx).ATAN = match(ATAN);
				setState(467);
				match(OPARENT);
				setState(468);
				((Primary_exprContext)_localctx).e = expr();
				...
				match(CPARENT);
				            ...
				            assert(((Primary_exprContext)_localctx).e.tree != null);
				            ((Primary_exprContext)_localctx).tree =  new Atan(((Primary_exprContext)_localctx).e.tree);
				            setLocation(_localctx.tree, ((Primary_exprContext)_localctx).ATAN);
	...
	public final IdentContext ident() throws RecognitionException {
		...
		try {
			...
			((IdentContext)_localctx).IDENT = match(IDENT);
			        ...
			        try{
			            ((IdentContext)_localctx).tree =  new Identifier(DecacCompiler.symbolTable.create((((IdentContext)_localctx).IDENT!=null?((IdentContext)_localctx).IDENT.getText():null)));
			            setLocation(_localctx.tree,((IdentContext)_localctx).IDENT); 
			        }
			        catch(Exception e){
			            ((IdentContext)_localctx).tree = null;
			        }
